...
def get_page_data(html):
    ...
    for tr in trs:
        ...
        try:
            name = tds[1].find('a', class_='currncy-name-container').text.strip()
        except:
            name = ''

        try:
            url = 'https://coinmarketcap.com' + tds[1].find('a', class_='currncy-name-container').get('href')
        except:
            url = ''
